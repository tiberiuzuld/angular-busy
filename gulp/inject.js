...
gulp.task('inject', ['scripts'], function () {
  var injectStylesDirective = gulp.src([
    path.join(conf.paths.src, '/angular-busy/**/*.css')
  ], {read: false});
  ...
  var injectScriptsDirective = gulp.src([
      path.join(conf.paths.src, '/angular-busy/**/*.module.js'),
      path.join(conf.paths.src, '/angular-busy/**/*.js'),
      path.join('!' + conf.paths.src, '/angular-busy/**/*.spec.js')
    ])
